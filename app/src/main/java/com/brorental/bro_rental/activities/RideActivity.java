...
import com.brorental.bro_rental.databinding.ActivityRideBinding;
...
public class RideActivity extends AppCompatActivity {
    ...
    private void addRide(long rideId) {
        ...
        map.put("broRentalName", appClass.sharedPref.getUser().getName());
        map.put("broRentalProfile", appClass.sharedPref.getUser().getProfileUrl());
