...
import com.brorental.bro_rental.databinding.FragmentProfileDetailsBinding;
...
public class ProfileEditDetails extends Fragment {
    ...
    private Intent getCameraIntent() {
        ...
        if (photoFile != null) {
            Uri photoURI = FileProvider.getUriForFile(getActivity(), "com.brorental.bro_rental.provider", photoFile);
